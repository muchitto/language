...
public class TypePropagationPass : SemanticPass, INodeHandler
{
    ...
    {
        foreach (var node in programContainerNode.Statements)
        {
            node.Accept(this);
        }
    }
    ...
    {
        foreach (var node in bodyContainerDeclarationNode.Statements)
        {
            node.Accept(this);
        }
    }
